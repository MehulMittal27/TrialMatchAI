...
def load_vllm_engine(
    ...
    # must be set at ENGINE BUILD time on the xgrammar backend: in vLLM 0.23.0 nothing reads the
    # per-request StructuredOutputsParams.disable_any_whitespace field, so it is not set there.
    # Adopted from upstream e4a6d5b.
